...
import { createEmployeeSecret, updateEmployee, fetchEmployee } from '../../services/employeeService';
...
const EmployeeFormRahasia = ({ mode = 'create', employeeData = {} }) => {
    ...
    const fetchEmployeeOptions = async () => {
        return {
            value: '3c5e0ba9-be85-4f16-baaa-476c6ad48bcd',
            label: 'fathul',
        };
        // try {
    ...
    const handleSubmit = async (e) => {
        ...
        const serviceFunction = mode === 'create' ? createEmployeeSecret : updateEmployee;
            ...
            <Grid container spacing={2} sx={{ px: 2, pt:2 }}>
                ...
                <Grid item xs={12} sm={6}>
                    <FormControl fullWidth>
                        ...
                        >
                            <MenuItem key="3c5e0ba9-be85-4f16-baaa-476c6ad48bcd" value="3c5e0ba9-be85-4f16-baaa-476c6ad48bcd">
                                Fathul
                            </MenuItem>
                        </Select>
                    </FormControl>
...
export default EmployeeFormRahasia;